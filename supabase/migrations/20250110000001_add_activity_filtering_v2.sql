...
-- Drop ALL existing versions of get_potential_matches_optimized function
-- Version 1: 3 parameters
...
-- Version 3: 8 parameters (the one from materialized views migration)
DROP FUNCTION IF EXISTS get_potential_matches_optimized(
    viewer_id uuid,
...
-- Create the new function with activity_filter parameter (9 parameters total)
